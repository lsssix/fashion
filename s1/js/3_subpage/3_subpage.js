...
$.getJSON("../data/3_subpage/subpage.json", function(json){
	 console.log(json);
	
	 //saleList2出售列表2
	 for(var i=0;i<48;i++){
	 	var saleList2 = $(".saleList2 img").eq(i);
	 	saleList2.attr("src",json.theme[i].img);
	 }
...
//		$.cookie("user", JSON.stringify(arr), {expires:7, path:"/"});
